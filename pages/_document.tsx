    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta
            name="description"
            content="A passionate software engineer on a journey to build amazing and inspiring software"
          />
          <meta
            name="keywords"
            content="Benjamin Scott, Software Engineer, Developer, Programmer"
          />
